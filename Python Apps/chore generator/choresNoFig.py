...
def print_title_screen():
    # Simple title without pyfiglet
    print("*************************************")
    print("** Welcome to Chore Boss 3000! **")
    print("*************************************")
    print("👨‍🍳👩‍🎨 The Ultimate Chore Assignment Machine! 🤖")
...
def assign_chores():
    chores = [
        "Unload Dishwasher 🍽️ (hope you like puzzles!)",
        "Load Dishwasher 🚿 (don't forget the soap!)",
        "Clean Counters 🧼 (sparkle and shine time!)",
        "Polish Appliances ✨ (make those shiny things SHINIER!)",
        "Clean Floors 🧹 (pretend you're Cinderella!)",
        "Organize Living Room 🛋️ (find the remote!)",
        "Take Out Trash 🗑️ (bonus cardio!)",
        "Clean Bathroom #1 🚽 (hold your nose!)",
        "Clean Bathroom #2 🚿 (scrub-a-dub-dub!)",
        "Clean Bathroom #3 🛁 (a throne fit for royalty!)"
    ]
